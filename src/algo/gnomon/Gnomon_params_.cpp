...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("Gnomon-params", CGnomon_params)
{
    SET_CLASS_MODULE("NCBI-GNOMON");
    ADD_NAMED_MEMBER("", m_data, STL_list_set, (STL_CRef, (CLASS, (CGnomon_param))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
