...
void CAlternative_protein_Base::C_Attlist::ResetProtein(void)
{
    m_Protein.erase();
    m_set_State[0] &= ~0x3;
}

void CAlternative_protein_Base::C_Attlist::ResetProtein_descr(void)
{
    m_Protein_descr.erase();
    m_set_State[0] &= ~0xc;
}

void CAlternative_protein_Base::C_Attlist::Reset(void)
{
    ResetProtein();
    ResetProtein_descr();
    ResetNum_tol_term();
...
BEGIN_NAMED_CLASS_INFO("", CAlternative_protein_Base::C_Attlist)
{
    SET_INTERNAL_NAME("alternative_protein", "Attlist");
...
// constructor
CAlternative_protein_Base::C_Attlist::C_Attlist(void)
    : m_Num_tol_term(0), m_Protein_mw(0)
{
...
void CAlternative_protein_Base::ResetAttlist(void)
{
    if ( !m_Attlist ) {
...
void CAlternative_protein_Base::SetAttlist(CAlternative_protein_Base::TAttlist& value)
{
    m_Attlist.Reset(&value);
    SetAlternative_protein();
}

void CAlternative_protein_Base::Reset(void)
{
    ResetAttlist();
    ResetAlternative_protein();
}

BEGIN_NAMED_BASE_CLASS_INFO("alternative_protein", CAlternative_protein)
{
    SET_CLASS_MODULE("pepXML");
    ...
    ADD_NAMED_NULL_MEMBER("alternative_protein", null, ())->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetNoPrefix()->SetNotag();
    info->RandomOrder();
}
END_CLASS_INFO

// constructor
CAlternative_protein_Base::CAlternative_protein_Base(void)
{
    memset(m_set_State,0,sizeof(m_set_State));
