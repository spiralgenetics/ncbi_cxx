...
BEGIN_NAMED_BASE_CLASS_INFO("MSSearchSettings", CMSSearchSettings)
{
    ...
    ADD_NAMED_STD_MEMBER("hitlistlen", m_Hitlistlen)->SetDefault(new THitlistlen(25))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_STD_MEMBER("minhit", m_Minhit)->SetDefault(new TMinhit(2))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("minspectra", m_Minspectra)->SetDefault(new TMinspectra(4))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("scale", m_Scale)->SetDefault(new TScale(100))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("maxmods", m_Maxmods)->SetDefault(new TMaxmods(64))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("taxids", m_Taxids, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_STD_MEMBER("pseudocount", m_Pseudocount)->SetDefault(new TPseudocount(1))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("searchb1", m_Searchb1)->SetDefault(new TSearchb1(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("searchctermproduct", m_Searchctermproduct)->SetDefault(new TSearchctermproduct(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("maxproductions", m_Maxproductions)->SetDefault(new TMaxproductions(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("minnoenzyme", m_Minnoenzyme)->SetDefault(new TMinnoenzyme(4))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("maxnoenzyme", m_Maxnoenzyme)->SetDefault(new TMaxnoenzyme(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("exactmass", m_Exactmass)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("settingid", m_Settingid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("iterativesettings", m_Iterativesettings, CMSIterativeSettings)->SetOptional();
    ADD_NAMED_STD_MEMBER("precursorcull", m_Precursorcull)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("infiles", m_Infiles, STL_list, (STL_CRef, (CLASS, (CMSInFile))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("outfiles", m_Outfiles, STL_list, (STL_CRef, (CLASS, (CMSOutFile))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("nocorrelationscore", m_Nocorrelationscore)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("probfollowingion", m_Probfollowingion)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("nmethionine", m_Nmethionine)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("automassadjust", m_Automassadjust)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("lomasscutoff", m_Lomasscutoff)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("libsearchsettings", m_Libsearchsettings, CMSLibrarySettings)->SetOptional();
    ADD_NAMED_MEMBER("noprolineions", m_Noprolineions, STL_list, (ENUM, (int, EMSIonType)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("reversesearch", m_Reversesearch)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("othersettings", m_Othersettings, STL_list, (STL_CRef, (CLASS, (CNameValue))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numisotopes", m_Numisotopes)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("pepppm", m_Pepppm)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("msmsppm", m_Msmsppm)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("reportedhitcount", m_Reportedhitcount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
