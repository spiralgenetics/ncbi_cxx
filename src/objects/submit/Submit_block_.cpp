...
BEGIN_NAMED_BASE_CLASS_INFO("Submit-block", CSubmit_block)
{
    ...
    ADD_NAMED_STD_MEMBER("hup", m_Hup)->SetDefault(new THup(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("reldate", m_Reldate, CDate)->SetOptional();
    ADD_NAMED_ENUM_MEMBER("subtype", m_Subtype, ESubtype)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("tool", m_Tool)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("user-tag", m_User_tag)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
