...
BEGIN_NAMED_BASE_CLASS_INFO("ID2-Request-Get-Blob-Id", CID2_Request_Get_Blob_Id)
{
    ...
    ADD_NAMED_MEMBER("sources", m_Sources, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_NULL_MEMBER("external", null, ())->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
