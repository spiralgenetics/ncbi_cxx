...
BEGIN_NAMED_BASE_CLASS_INFO("ID2-Reply-Get-Blob-Id", CID2_Reply_Get_Blob_Id)
{
    ...
    ADD_NAMED_STD_MEMBER("split-version", m_Split_version)->SetDefault(new TSplit_version(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("annot-info", m_Annot_info, STL_list, (STL_CRef, (CLASS, (CID2S_Seq_annot_Info))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_NULL_MEMBER("end-of-reply", null, ())->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("blob-state", m_Blob_state)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
