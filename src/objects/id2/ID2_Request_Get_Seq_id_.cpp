...
BEGIN_NAMED_BASE_CLASS_INFO("ID2-Request-Get-Seq-id", CID2_Request_Get_Seq_id)
{
    ...
    ADD_NAMED_ENUM_MEMBER("seq-id-type", m_Seq_id_type, ESeq_id_type)->SetDefault(new TSeq_id_type(eSeq_id_type_any))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
