...
BEGIN_NAMED_BASE_CLASS_INFO("ID2-Get-Blob-Details", CID2_Get_Blob_Details)
{
    ...
    ADD_NAMED_STD_MEMBER("seq-class-level", m_Seq_class_level)->SetDefault(new TSeq_class_level(1))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("descr-level", m_Descr_level)->SetDefault(new TDescr_level(1))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("descr-type-mask", m_Descr_type_mask)->SetDefault(new TDescr_type_mask(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("annot-type-mask", m_Annot_type_mask)->SetDefault(new TAnnot_type_mask(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("feat-type-mask", m_Feat_type_mask)->SetDefault(new TFeat_type_mask(0))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("sequence-level", m_Sequence_level, ESequence_level)->SetDefault(new TSequence_level(eSequence_level_none))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
