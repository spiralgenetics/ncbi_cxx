...
BEGIN_NAMED_BASE_CLASS_INFO("HGVS-Coordinate", CHGVS_Coordinate)
{
    ...
    ADD_NAMED_STD_MEMBER("object-id", m_Object_id)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("pos-mapped", m_Pos_mapped)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
