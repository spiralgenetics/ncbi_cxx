...
BEGIN_NAMED_BASE_CLASS_INFO("TMgr-Assembly", CTMgr_Assembly)
{
    ...
    ADD_NAMED_STD_MEMBER("short-name", m_Short_name)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("description", m_Description)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("is-complete", m_Is_complete)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
