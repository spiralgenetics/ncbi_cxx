...
BEGIN_NAMED_BASE_CLASS_INFO("TMgr-TrackAttrValueReply", CTMgr_TrackAttrValueReply)
{
    ...
    ADD_NAMED_MEMBER("track-type-list", m_Track_type_list, STL_list_set, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("attr-list", m_Attr_list, CTMgr_AttrReply)->SetOptional();
    ADD_NAMED_MEMBER("value-list", m_Value_list, STL_list_set, (STL_CRef, (CLASS, (CTMgr_AttrValueReply))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
