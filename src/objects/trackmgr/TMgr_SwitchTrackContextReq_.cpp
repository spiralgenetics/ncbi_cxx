...
void CTMgr_SwitchTrackContextRequest_Base::ResetNew_genome_contexts(void)
{
    m_New_genome_contexts.clear();
    m_set_State[0] &= ~0xc;
}
...
BEGIN_NAMED_BASE_CLASS_INFO("TMgr-SwitchTrackContextRequest", CTMgr_SwitchTrackContextRequest)
{
    ...
    ADD_NAMED_MEMBER("new-genome-contexts", m_New_genome_contexts, STL_list, (STL_CRef, (CLASS, (CTMgr_GenomeContext))))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("current-dtrack-ids", m_Current_dtrack_ids, STL_list, (STD, (int)))->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
