...
BEGIN_NAMED_BASE_CLASS_INFO("Sequence-constraint", CSequence_constraint)
{
    ...
    ADD_NAMED_ENUM_MEMBER("strandedness", m_Strandedness, EFeature_strandedness_constraint)->SetDefault(new TStrandedness(eFeature_strandedness_constraint_any))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
