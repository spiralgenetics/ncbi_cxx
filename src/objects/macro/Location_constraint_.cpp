...
BEGIN_NAMED_BASE_CLASS_INFO("Location-constraint", CLocation_constraint)
{
    ...
    ADD_NAMED_ENUM_MEMBER("strand", m_Strand, EStrand_constraint)->SetDefault(new TStrand(eStrand_constraint_any))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("seq-type", m_Seq_type, ESeqtype_constraint)->SetDefault(new TSeq_type(eSeqtype_constraint_any))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("partial5", m_Partial5, EPartial_constraint)->SetDefault(new TPartial5(ePartial_constraint_either))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("partial3", m_Partial3, EPartial_constraint)->SetDefault(new TPartial3(ePartial_constraint_either))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("location-type", m_Location_type, ELocation_type_constraint)->SetDefault(new TLocation_type(eLocation_type_constraint_any))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
