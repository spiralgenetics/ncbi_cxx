...
BEGIN_NAMED_BASE_CLASS_INFO("HG-Commentary", CHG_Commentary)
{
    ...
    ADD_NAMED_STD_MEMBER("provider", m_Provider)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("other-links", m_Other_links, STL_list_set, (STL_CRef, (CLASS, (CHG_Link))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("other-commentaries", m_Other_commentaries, STL_list_set, (STL_CRef, (CLASS, (CHG_Commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
