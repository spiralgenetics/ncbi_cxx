...
BEGIN_NAMED_BASE_CLASS_INFO("HG-Entry", CHG_Entry)
{
    ...
    ADD_NAMED_STD_MEMBER("caption", m_Caption)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("taxid", m_Taxid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("genes", m_Genes, STL_list_set, (STL_CRef, (CLASS, (CHG_Gene))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("cr-date", m_Cr_date, CDate)->SetOptional();
    ADD_NAMED_REF_MEMBER("up-date", m_Up_date, CDate)->SetOptional();
    ADD_NAMED_MEMBER("distances", m_Distances, STL_list_set, (STL_CRef, (CLASS, (CHG_Stats))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("commentaries", m_Commentaries, STL_list_set, (STL_CRef, (CLASS, (CHG_CommentarySet))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("warnings", m_Warnings, STL_list_set, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
