...
BEGIN_NAMED_BASE_CLASS_INFO("Pssm", CPssm)
{
    ...
    ADD_NAMED_STD_MEMBER("isProtein", m_IsProtein)->SetDefault(new TIsProtein(true))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("rowLabels", m_RowLabels, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("byRow", m_ByRow)->SetDefault(new TByRow(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
