...
BEGIN_NAMED_BASE_CLASS_INFO("T3Data", CT3Data)
{
    ...
    ADD_NAMED_MEMBER("blast-name-lineage", m_Blast_name_lineage, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("status", m_Status, STL_list, (STL_CRef, (CLASS, (CT3StatusFlags))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
