...
BEGIN_NAMED_BASE_CLASS_INFO("Comment-rule", CComment_rule)
{
    ...
    ADD_NAMED_STD_MEMBER("updated", m_Updated)->SetDefault(new TUpdated(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("fields", m_Fields, CField_set);
    ADD_NAMED_STD_MEMBER("require-order", m_Require_order)->SetDefault(new TRequire_order(true))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("allow-unlisted", m_Allow_unlisted)->SetDefault(new TAllow_unlisted(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
