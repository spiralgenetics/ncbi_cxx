...
BEGIN_NAMED_BASE_CLASS_INFO("Entrezgene", CEntrezgene)
{
    ...
    ADD_NAMED_STD_MEMBER("summary", m_Summary)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("location", m_Location, STL_list, (STL_CRef, (CLASS, (CMaps))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("gene-source", m_Gene_source, CGene_source)->SetOptional();
    ADD_NAMED_MEMBER("locus", m_Locus, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("properties", m_Properties, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("refgene", m_Refgene, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("homology", m_Homology, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("comments", m_Comments, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("unique-keys", m_Unique_keys, STL_list, (STL_CRef, (CLASS, (CDbtag))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("xtra-index-terms", m_Xtra_index_terms, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("xtra-properties", m_Xtra_properties, STL_list, (STL_CRef, (CLASS, (CXtra_Terms))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("xtra-iq", m_Xtra_iq, STL_list, (STL_CRef, (CLASS, (CXtra_Terms))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("non-unique-keys", m_Non_unique_keys, STL_list, (STL_CRef, (CLASS, (CDbtag))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
