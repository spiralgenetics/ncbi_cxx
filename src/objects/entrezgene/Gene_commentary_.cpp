...
BEGIN_NAMED_BASE_CLASS_INFO("Gene-commentary", CGene_commentary)
{
    ...
    ADD_NAMED_STD_MEMBER("heading", m_Heading)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("label", m_Label)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("text", m_Text)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("accession", m_Accession)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("refs", m_Refs, STL_list, (STL_CRef, (CLASS, (CPub))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("source", m_Source, STL_list, (STL_CRef, (CLASS, (COther_source))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("genomic-coords", m_Genomic_coords, STL_list, (STL_CRef, (CLASS, (CSeq_loc))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("seqs", m_Seqs, STL_list, (STL_CRef, (CLASS, (CSeq_loc))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("products", m_Products, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("comment", m_Comment, STL_list, (STL_CRef, (CLASS, (CGene_commentary))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
