...
BEGIN_NAMED_BASE_CLASS_INFO("Biostruc-seqs-aligns-cdd", CBiostruc_seqs_aligns_cdd)
{
    ...
    ADD_NAMED_MEMBER("structures", m_Structures, STL_list_set, (STL_CRef, (CLASS, (CBiostruc))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("structure-type", m_Structure_type, EStructure_type)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
