...
BEGIN_NAMED_BASE_CLASS_INFO("Bundle-seqs-aligns", CBundle_seqs_aligns)
{
    ...
    ADD_NAMED_MEMBER("sequences", m_Sequences, STL_list_set, (STL_CRef, (CLASS, (CSeq_entry))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("seqaligns", m_Seqaligns, STL_list_set, (STL_CRef, (CLASS, (CSeq_annot))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("strucaligns", m_Strucaligns, CBiostruc_annot_set)->SetOptional();
    ADD_NAMED_MEMBER("imports", m_Imports, STL_list_set, (STL_CRef, (CLASS, (CSeq_annot))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
