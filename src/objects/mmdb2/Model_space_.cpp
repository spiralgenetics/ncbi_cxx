...
BEGIN_NAMED_BASE_CLASS_INFO("Model-space", CModel_space)
{
    ...
    ADD_NAMED_ENUM_MEMBER("thermal-factor-units", m_Thermal_factor_units, EThermal_factor_units)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("occupancy-factor-units", m_Occupancy_factor_units, EOccupancy_factor_units)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("density-units", m_Density_units, EDensity_units)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
