...
BEGIN_NAMED_BASE_CLASS_INFO("Cdd-Project", CCdd_Project)
{
    ...
    ADD_NAMED_MEMBER("scripts", m_Scripts, STL_list, (STL_CRef, (CLASS, (CCdd_Script))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_REF_MEMBER("id", m_Id, CCdd_id_set)->SetOptional();
    ADD_NAMED_MEMBER("rids", m_Rids, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_STD_MEMBER("project-id", m_Project_id)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
