...
BEGIN_NAMED_BASE_CLASS_INFO("Cdd", CCdd)
{
    ...
    ADD_NAMED_MEMBER("seqannot", m_Seqannot, STL_list, (STL_CRef, (CLASS, (CSeq_annot))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("pending", m_Pending, STL_list, (STL_CRef, (CLASS, (CUpdate_align))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("rejects", m_Rejects, STL_list, (STL_CRef, (CLASS, (CReject_id))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("master3d", m_Master3d, STL_list_set, (STL_CRef, (CLASS, (CSeq_id))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("ancestors", m_Ancestors, STL_list, (STL_CRef, (CLASS, (CDomain_parent))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
