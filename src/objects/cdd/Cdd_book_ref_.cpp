...
BEGIN_NAMED_BASE_CLASS_INFO("Cdd-book-ref", CCdd_book_ref)
{
    ...
    ADD_NAMED_STD_MEMBER("elementid", m_Elementid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("subelementid", m_Subelementid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("celementid", m_Celementid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("csubelementid", m_Csubelementid)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
