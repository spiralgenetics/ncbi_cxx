...
BEGIN_NAMED_BASE_CLASS_INFO("PC-AssayTargetInfo", CPC_AssayTargetInfo)
{
    ...
    ADD_NAMED_ENUM_MEMBER("molecule-type", m_Molecule_type, EMolecule_type)->SetDefault(new TMolecule_type(eMolecule_type_protein))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
