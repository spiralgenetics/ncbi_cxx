...
BEGIN_NAMED_BASE_CLASS_INFO("PC-AssayDRAttr", CPC_AssayDRAttr)
{
    ...
    ADD_NAMED_STD_MEMBER("dn", m_Dn)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("rn", m_Rn)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
