...
BEGIN_NAMED_BASE_CLASS_INFO("PC-AssayResults", CPC_AssayResults)
{
    ...
    ADD_NAMED_ENUM_MEMBER("outcome", m_Outcome, EOutcome)->SetDefault(new TOutcome(eOutcome_unspecified))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("rank", m_Rank)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("data", m_Data, STL_vector, (STL_CRef, (CLASS, (CPC_AssayData))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("url", m_Url)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
