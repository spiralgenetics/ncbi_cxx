...
BEGIN_NAMED_CLASS_INFO("", CAssembly_Base::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("groupLabel", m_GroupLabel)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("assemblySource", m_AssemblySource)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("current", m_Current)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
...
BEGIN_NAMED_CLASS_INFO("", CAssembly_Base::C_SnpStat::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("chromCount", m_ChromCount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("placedContigCount", m_PlacedContigCount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("unplacedContigCount", m_UnplacedContigCount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("seqlocCount", m_SeqlocCount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("hapCount", m_HapCount)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_BASE_CLASS_INFO("Assembly", CAssembly)
{
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_REF_MEMBER("attlist", m_Attlist, C_Attlist);
    ADD_NAMED_MEMBER("component", m_Component, STL_list, (STL_CRef, (CLASS, (CComponent))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
