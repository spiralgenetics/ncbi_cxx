...
BEGIN_NAMED_CLASS_INFO("", CAssay_Base::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("handle", m_Handle)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("batch", m_Batch)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("batchId", m_BatchId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("batchType", m_BatchType, EAttlist_batchType)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_STD_MEMBER("population", m_Population)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
...
BEGIN_NAMED_CLASS_INFO("", CAssay_Base::C_Method::C_EMethod::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("id", m_Id)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_BASE_CLASS_INFO("Assay", CAssay)
{
    ...
    ADD_NAMED_MEMBER("strains", m_Strains, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("comment", m_Comment)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("citation", m_Citation, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
