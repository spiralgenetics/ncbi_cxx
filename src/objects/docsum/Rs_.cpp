...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("validProbMin", m_ValidProbMin)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("validProbMax", m_ValidProbMax)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("genotype", m_Genotype)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("bitField", m_BitField)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("taxId", m_TaxId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Het::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("stdError", m_StdError)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Validation::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("byCluster", m_ByCluster)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("byFrequency", m_ByFrequency)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("byOtherPop", m_ByOtherPop)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("by2Hit2Allele", m_By2Hit2Allele)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("byHapMap", m_ByHapMap)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("by1000G", m_By1000G)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Validation)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_REF_MEMBER("attlist", m_Attlist, C_Attlist);
    ADD_NAMED_MEMBER("otherPopBatchId", m_OtherPopBatchId, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("twoHit2AlleleBatchId", m_TwoHit2AlleleBatchId, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("frequencyClass", m_FrequencyClass, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("hapMapPhase", m_HapMapPhase, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("tGPPhase", m_TGPPhase, STL_list, (STD, (int)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("suspectEvidence", m_SuspectEvidence, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Create::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("build", m_Build)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("date", m_Date)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Sequence::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("ancestralAllele", m_AncestralAllele)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_Sequence)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_REF_MEMBER("attlist", m_Attlist, C_Attlist);
    ADD_NAMED_STD_MEMBER("seq5", m_Seq5)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("observed", m_Observed)->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("seq3", m_Seq3)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_E_MergeHistory::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("rsId", m_RsId)->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("buildId", m_BuildId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("orientFlip", m_OrientFlip)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_E_AlleleOrigin::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("allele", m_Allele)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_E_Phenotype)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_MEMBER("clinicalSignificance", m_ClinicalSignificance, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_E_BioSource)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_MEMBER("genome", m_Genome, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("origin", m_Origin, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CRs_Base::C_E_Frequency::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("freq", m_Freq)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("allele", m_Allele)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("popId", m_PopId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("sampleSize", m_SampleSize)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_BASE_CLASS_INFO("Rs", CRs)
{
    ...
    ADD_NAMED_MEMBER("assembly", m_Assembly, STL_list, (STL_CRef, (CLASS, (CAssembly))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("primarySequence", m_PrimarySequence, STL_list, (STL_CRef, (CLASS, (CPrimarySequence))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("rsStruct", m_RsStruct, STL_list, (STL_CRef, (CLASS, (CRsStruct))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("rsLinkout", m_RsLinkout, STL_list, (STL_CRef, (CLASS, (CRsLinkout))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("mergeHistory", m_MergeHistory, STL_list, (STL_CRef, (CLASS, (C_E_MergeHistory))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("hgvs", m_Hgvs, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("alleleOrigin", m_AlleleOrigin, STL_list, (STL_CRef, (CLASS, (C_E_AlleleOrigin))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("phenotype", m_Phenotype, STL_list, (STL_CRef, (CLASS, (C_E_Phenotype))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("bioSource", m_BioSource, STL_list, (STL_CRef, (CLASS, (C_E_BioSource))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("frequency", m_Frequency, STL_list, (STL_CRef, (CLASS, (C_E_Frequency))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
