...
BEGIN_NAMED_CLASS_INFO("", CSs_Base::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("locSnpId", m_LocSnpId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("subSnpClass", m_SubSnpClass, EAttlist_subSnpClass)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("orient", m_Orient, EAttlist_orient)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("strand", m_Strand, EAttlist_strand)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("molType", m_MolType, EAttlist_molType)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("buildId", m_BuildId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("methodClass", m_MethodClass, EAttlist_methodClass)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("validated", m_Validated, EAttlist_validated)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("linkoutUrl", m_LinkoutUrl)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("ssAlias", m_SsAlias)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("alleleOrigin", m_AlleleOrigin)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("clinicalSignificance", m_ClinicalSignificance)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
