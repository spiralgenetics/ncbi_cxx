...
BEGIN_NAMED_CLASS_INFO("", CExchangeSet_Base::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("setType", m_SetType)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("setDepth", m_SetDepth)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("specVersion", m_SpecVersion)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("dbSnpBuild", m_DbSnpBuild)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("generated", m_Generated)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
...
BEGIN_NAMED_CLASS_INFO("", CExchangeSet_Base::C_SourceDatabase::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("dbSnpOrgAbbr", m_DbSnpOrgAbbr)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("gpipeOrgAbbr", m_GpipeOrgAbbr)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CExchangeSet_Base::C_Query::C_Attlist)
{
    ...
    ADD_NAMED_STD_MEMBER("string", m_String)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_CLASS_INFO("", CExchangeSet_Base::C_Summary::C_Attlist)
{
    ...
    SET_CLASS_MODULE("Docsum-3-4");
    ADD_NAMED_STD_MEMBER("numRsIds", m_NumRsIds)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("totalSeqLength", m_TotalSeqLength)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numContigHits", m_NumContigHits)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numGeneHits", m_NumGeneHits)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numGiHits", m_NumGiHits)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("num3dStructs", m_Num3dStructs)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numAlleleFreqs", m_NumAlleleFreqs)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numStsHits", m_NumStsHits)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("numUnigeneCids", m_NumUnigeneCids)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->SetRandomOrder(true);
}
END_CLASS_INFO
...
BEGIN_NAMED_BASE_CLASS_INFO("ExchangeSet", CExchangeSet)
{
    ...
    ADD_NAMED_MEMBER("rs", m_Rs, STL_list, (STL_CRef, (CLASS, (CRs))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("baseURL", m_BaseURL, STL_list, (STL_CRef, (CLASS, (CBaseURL))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
