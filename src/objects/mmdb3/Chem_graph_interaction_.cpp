...
BEGIN_NAMED_BASE_CLASS_INFO("Chem-graph-interaction", CChem_graph_interaction)
{
    ...
    ADD_NAMED_MEMBER("residue-contacts", m_Residue_contacts, STL_list, (STL_CRef, (CLASS, (CChem_graph_pntrs))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("atom-contacts", m_Atom_contacts, STL_list, (STL_CRef, (CLASS, (CChem_graph_pntrs))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("atom-distance", m_Atom_distance, STL_list, (STL_CRef, (CLASS, (CRealValue))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
