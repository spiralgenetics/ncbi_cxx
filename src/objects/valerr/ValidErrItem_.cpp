...
BEGIN_NAMED_BASE_CLASS_INFO("ValidErrItem", CValidErrItem)
{
    ...
    ADD_NAMED_STD_MEMBER("featureId", m_FeatureId)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("seqOffset", m_SeqOffset)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_ENUM_MEMBER("objectType", m_ObjectType, EObjectType)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("errorName", m_ErrorName)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("errorGroup", m_ErrorGroup)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("accnver", m_Accnver)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
