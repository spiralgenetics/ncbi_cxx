...
BEGIN_NAMED_BASE_CLASS_INFO("GBReference", CGBReference)
{
    ...
    ADD_NAMED_MEMBER("authors", m_Authors, STL_list, (CLASS, (CGBAuthor)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("xref", m_Xref, STL_list, (STL_CRef, (CLASS, (CGBXref))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
