...
BEGIN_NAMED_BASE_CLASS_INFO("Clone-ref", CClone_ref)
{
    ...
    ADD_NAMED_STD_MEMBER("library", m_Library)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("concordant", m_Concordant)->SetDefault(new TConcordant(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("unique", m_Unique)->SetDefault(new TUnique(false))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
