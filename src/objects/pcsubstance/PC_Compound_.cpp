...
BEGIN_NAMED_BASE_CLASS_INFO("PC-Compound", CPC_Compound)
{
    ...
    ADD_NAMED_MEMBER("stereo", m_Stereo, STL_list, (STL_CRef, (CLASS, (CPC_StereoCenter))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("coords", m_Coords, STL_list, (STL_CRef, (CLASS, (CPC_Coordinates))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_STD_MEMBER("charge", m_Charge)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("props", m_Props, STL_list, (STL_CRef, (CLASS, (CPC_InfoData))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("stereogroups", m_Stereogroups, STL_list, (STL_CRef, (CLASS, (CPC_StereoGroup))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
