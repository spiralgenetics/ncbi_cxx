...
BEGIN_NAMED_BASE_CLASS_INFO("PC-Coordinates", CPC_Coordinates)
{
    ...
    ADD_NAMED_MEMBER("conformers", m_Conformers, STL_list, (STL_CRef, (CLASS, (CPC_Conformer))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("atomlabels", m_Atomlabels, STL_list, (STL_CRef, (CLASS, (CPC_AtomString))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("data", m_Data, STL_list, (STL_CRef, (CLASS, (CPC_InfoData))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
