...
int CID1Client_Base::AskGetgi(const CSeq_id& req, CID1Client_Base::TReply* reply)
{
    TRequestChoice request;
    TReply         reply0;
...
list< CRef< CSeq_id > > CID1Client_Base::AskGetseqidsfromgi(const int& req, CID1Client_Base::TReply* reply)
{
    TRequestChoice request;
    TReply         reply0;
    request.SetGetseqidsfromgi(const_cast<int&>(req));
    if ( !reply ) {
        reply = &reply0;
    }
...
list< CRef< CID1Seq_hist > > CID1Client_Base::AskGetgihist(const int& req, CID1Client_Base::TReply* reply)
{
    TRequestChoice request;
    TReply         reply0;
    request.SetGetgihist(const_cast<int&>(req));
    if ( !reply ) {
        reply = &reply0;
    }
...
list< CRef< CID1Seq_hist > > CID1Client_Base::AskGetgirev(const int& req, CID1Client_Base::TReply* reply)
{
    TRequestChoice request;
    TReply         reply0;
    request.SetGetgirev(const_cast<int&>(req));
    if ( !reply ) {
        reply = &reply0;
    }
...
int CID1Client_Base::AskGetgistate(const int& req, CID1Client_Base::TReply* reply)
{
    TRequestChoice request;
    TReply         reply0;
    request.SetGetgistate(const_cast<int&>(req));
    if ( !reply ) {
        reply = &reply0;
    }
