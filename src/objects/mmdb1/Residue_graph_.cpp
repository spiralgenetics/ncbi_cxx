...
BEGIN_NAMED_BASE_CLASS_INFO("Residue-graph", CResidue_graph)
{
    ...
    ADD_NAMED_ENUM_MEMBER("residue-type", m_Residue_type, EResidue_type)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("iupac-code", m_Iupac_code, STL_list, (STD, (string)))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ...
    ADD_NAMED_MEMBER("chiral-centers", m_Chiral_centers, STL_list, (STL_CRef, (CLASS, (CChiral_center))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
