...
BEGIN_NAMED_BASE_CLASS_INFO("Biostruc", CBiostruc)
{
    ...
    ADD_NAMED_MEMBER("features", m_Features, STL_list, (STL_CRef, (CLASS, (CBiostruc_feature_set))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("model", m_Model, STL_list, (STL_CRef, (CLASS, (CBiostruc_model))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
