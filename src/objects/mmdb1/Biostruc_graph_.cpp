...
BEGIN_NAMED_BASE_CLASS_INFO("Biostruc-graph", CBiostruc_graph)
{
    ...
    ADD_NAMED_MEMBER("inter-molecule-bonds", m_Inter_molecule_bonds, STL_list, (STL_CRef, (CLASS, (CInter_residue_bond))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    ADD_NAMED_MEMBER("residue-graphs", m_Residue_graphs, STL_list, (STL_CRef, (CLASS, (CResidue_graph))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]));
    info->RandomOrder();
}
END_CLASS_INFO
