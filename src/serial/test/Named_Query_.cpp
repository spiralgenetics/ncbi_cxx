...
void CNamed_Query_Base::SetName(CNamed_Query_Base::TName& value)
{
    m_Name.Reset(&value);
}
...
void CNamed_Query_Base::SetTime(CNamed_Query_Base::TTime& value)
{
    m_Time.Reset(&value);
}
...
void CNamed_Query_Base::SetCommand(CNamed_Query_Base::TCommand& value)
{
