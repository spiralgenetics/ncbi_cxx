...
#include <objtools/eutils/esummary/esummary_module.hpp>
...
void esummary_RegisterModuleClasses(void)
{
    esummary::CDocSum::GetTypeInfo();
    esummary::CESummaryResult::GetTypeInfo();
    esummary::CItem::GetTypeInfo();
}
