...
#include <objtools/eutils/ehistory/ehistory_module.hpp>
...
void ehistory_RegisterModuleClasses(void)
{
    ehistory::CEHistoryItem::GetTypeInfo();
    ehistory::CEHistoryResult::GetTypeInfo();
}
