...
void CTolower_Base::C_Data::DoSelect(E_Choice index, NCBI_NS_NCBI::CObjectMemoryPool* pool)
{
    switch ( index ) {
    case e_Pad:
...
void CTolower_Base::C_Data::Set_CharData(const CTolower_Base::C_Data::T_CharData& value)
{
...
void CTolower_Base::C_Data::SetPad(CTolower_Base::C_Data::TPad& value)
{
    TPad* ptr = &value;
...
void CTolower_Base::C_Data::SetApad(CTolower_Base::C_Data::TApad& value)
{
    TApad* ptr = &value;
...
void CTolower_Base::C_Data::SetSubs(CTolower_Base::C_Data::TSubs& value)
{
    TSubs* ptr = &value;
...
void CTolower_Base::C_Data::SetToupper(CTolower_Base::C_Data::TToupper& value)
{
    TToupper* ptr = &value;
...
void CTolower_Base::C_Data::SetTolower(CTolower_Base::C_Data::TTolower& value)
{
    TTolower* ptr = &value;
...
void CTolower_Base::C_Data::SetStrip(CTolower_Base::C_Data::TStrip& value)
{
    TStrip* ptr = &value;
...
void CTolower_Base::C_Data::SetNormalize(CTolower_Base::C_Data::TNormalize& value)
{
...
// type info
BEGIN_NAMED_CHOICE_INFO("", CTolower_Base::C_Data)
{
    SET_INTERNAL_NAME("tolower", "E");
...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("tolower", CTolower)
{
