...
void CRule_Base::C_Data::DoSelect(E_Choice index, NCBI_NS_NCBI::CObjectMemoryPool* pool)
{
    switch ( index ) {
    case e_Pad:
...
void CRule_Base::C_Data::Set_CharData(const CRule_Base::C_Data::T_CharData& value)
{
...
void CRule_Base::C_Data::SetPad(CRule_Base::C_Data::TPad& value)
{
    TPad* ptr = &value;
...
void CRule_Base::C_Data::SetApad(CRule_Base::C_Data::TApad& value)
{
    TApad* ptr = &value;
...
void CRule_Base::C_Data::SetSubs(CRule_Base::C_Data::TSubs& value)
{
    TSubs* ptr = &value;
...
void CRule_Base::C_Data::SetToupper(CRule_Base::C_Data::TToupper& value)
{
    TToupper* ptr = &value;
...
void CRule_Base::C_Data::SetTolower(CRule_Base::C_Data::TTolower& value)
{
    TTolower* ptr = &value;
...
void CRule_Base::C_Data::SetStrip(CRule_Base::C_Data::TStrip& value)
{
    TStrip* ptr = &value;
...
void CRule_Base::C_Data::SetNormalize(CRule_Base::C_Data::TNormalize& value)
{
...
// type info
BEGIN_NAMED_CHOICE_INFO("", CRule_Base::C_Data)
{
    SET_INTERNAL_NAME("Rule", "E");
...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("Rule", CRule)
{
