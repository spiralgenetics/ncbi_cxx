...
BEGIN_NAMED_CLASS_INFO("", CSubs_Base::C_Attlist)
{
    SET_INTERNAL_NAME("subs", "Attlist");
    SET_CLASS_MODULE("linkout");
    ADD_NAMED_STD_MEMBER("for", m_For)->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetNoPrefix();
...
void CSubs_Base::C_E_Subs::DoSelect(E_Choice index, NCBI_NS_NCBI::CObjectMemoryPool* pool)
{
    switch ( index ) {
    case e_Pad:
...
void CSubs_Base::C_E_Subs::Set_CharData(const CSubs_Base::C_E_Subs::T_CharData& value)
{
...
void CSubs_Base::C_E_Subs::SetPad(CSubs_Base::C_E_Subs::TPad& value)
{
    TPad* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetApad(CSubs_Base::C_E_Subs::TApad& value)
{
    TApad* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetSubs(CSubs_Base::C_E_Subs::TSubs& value)
{
    TSubs* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetToupper(CSubs_Base::C_E_Subs::TToupper& value)
{
    TToupper* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetTolower(CSubs_Base::C_E_Subs::TTolower& value)
{
    TTolower* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetStrip(CSubs_Base::C_E_Subs::TStrip& value)
{
    TStrip* ptr = &value;
...
void CSubs_Base::C_E_Subs::SetNormalize(CSubs_Base::C_E_Subs::TNormalize& value)
{
...
// type info
BEGIN_NAMED_CHOICE_INFO("", CSubs_Base::C_E_Subs)
{
    SET_INTERNAL_NAME("subs.subs", "E");
...
BEGIN_NAMED_BASE_CLASS_INFO("subs", CSubs)
{
    SET_CLASS_MODULE("linkout");
    ADD_NAMED_REF_MEMBER("Attlist", m_Attlist, C_Attlist)->SetNoPrefix()->SetAttlist();
    ADD_NAMED_MEMBER("subs", m_Subs, STL_list, (STL_CRef, (CLASS, (C_E_Subs))))->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetNoPrefix()->SetNotag();
    info->RandomOrder();
}
END_CLASS_INFO
