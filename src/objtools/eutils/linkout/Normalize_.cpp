...
void CNormalize_Base::C_Data::DoSelect(E_Choice index, NCBI_NS_NCBI::CObjectMemoryPool* pool)
{
    switch ( index ) {
    case e_Pad:
...
void CNormalize_Base::C_Data::Set_CharData(const CNormalize_Base::C_Data::T_CharData& value)
{
...
void CNormalize_Base::C_Data::SetPad(CNormalize_Base::C_Data::TPad& value)
{
    TPad* ptr = &value;
...
void CNormalize_Base::C_Data::SetApad(CNormalize_Base::C_Data::TApad& value)
{
    TApad* ptr = &value;
...
void CNormalize_Base::C_Data::SetSubs(CNormalize_Base::C_Data::TSubs& value)
{
    TSubs* ptr = &value;
...
void CNormalize_Base::C_Data::SetToupper(CNormalize_Base::C_Data::TToupper& value)
{
    TToupper* ptr = &value;
...
void CNormalize_Base::C_Data::SetTolower(CNormalize_Base::C_Data::TTolower& value)
{
    TTolower* ptr = &value;
...
void CNormalize_Base::C_Data::SetStrip(CNormalize_Base::C_Data::TStrip& value)
{
    TStrip* ptr = &value;
...
void CNormalize_Base::C_Data::SetNormalize(CNormalize_Base::C_Data::TNormalize& value)
{
...
// type info
BEGIN_NAMED_CHOICE_INFO("", CNormalize_Base::C_Data)
{
    SET_INTERNAL_NAME("normalize", "E");
...
BEGIN_NAMED_BASE_IMPLICIT_CLASS_INFO("normalize", CNormalize)
{
