...
#include <objtools/eutils/egquery/egquery_module.hpp>
...
void egquery_RegisterModuleClasses(void)
{
    egquery::CEGQueryResult::GetTypeInfo();
    egquery::CResult::GetTypeInfo();
    egquery::CResultItem::GetTypeInfo();
}
