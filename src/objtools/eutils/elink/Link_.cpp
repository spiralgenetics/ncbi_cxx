...
void CLink_Base::SetId(CLink_Base::TId& value)
{
    m_Id.Reset(&value);
}

void CLink_Base::SetId(const NCBI_NS_STD::string& value)
{
    SetId() = value;
}

void CLink_Base::ResetScore(void)
{
    m_Score.erase();
    m_set_State[0] &= ~0xc;
}
...
BEGIN_NAMED_BASE_CLASS_INFO("Link", CLink)
{
    ...
    ADD_NAMED_STD_MEMBER("Score", m_Score)->SetOptional()->SetSetFlag(MEMBER_PTR(m_set_State[0]))->SetNoPrefix();
    info->RandomOrder();
}
END_CLASS_INFO
