...
#ifndef espell_REGISTERMODULECLASSES_HPP
#define espell_REGISTERMODULECLASSES_HPP
...
NCBI_EUTILS_EXPORT
void espell_RegisterModuleClasses(void);

END_espell_SCOPE // namespace espell::


#endif // espell_REGISTERMODULECLASSES_HPP
